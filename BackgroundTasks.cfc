<cfcomponent output="false">
	...
	<cffunction name="scheduleTask" returntype="boolean" hint="Schedules task in background tasks queue. Returns whether or not the task was scheduled successfully." output="false">
		...
		<cfargument name="params" type="string" required="false" default="{}" hint="Struct of arguments to pass to the task, serialized as a JSON object string.">
		<cfargument name="priority" type="numeric" required="false" default="0" hint="Priority. Lower number is higher priority.">
